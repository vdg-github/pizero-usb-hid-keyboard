...
echo "  Keyboard:  $SCRIPT_DIR/sendkeys h i"
echo "  String:    $SCRIPT_DIR/sendkeys -s 'Hello, world!'"
echo "  Mouse:     $SCRIPT_DIR/sendkeys -m '--b1'          # left click"
echo "  Mouse:     $SCRIPT_DIR/sendkeys -m '50 0'          # move right 50px"
